...
echo ""
echo ""
echo "                      $BLUE 1. Think Before You Type!"
echo "                      $BLUE 2. Respect Other's Privacy and Feelings!"
echo "                      $GREEN 3. With Great Powers comes Great Responsibilities!!"
echo ""
echo ""
echo ""
sleep 3
...
echo ""
sleep 1
echo "                                    $WHITE Created by:$CYAN Shaurya $MAGENTA Anonymous-ly"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo ""
    echo -e "\e[92m[\e[91m~\e[92m]\e[93m Shit! You are not connected to internet !\e[93m"
    echo ""
    echo -e "\e[92m[\e[91m~\e[92m]\e[93m Please connect and try again LATER!! !!\e[93m"
    echo ""
    echo ""
    exit
fi
...
output=$(cat .output.txt | grep "123")
if [[ $output = "123" ]]
then
exit
fi
